    ...
    <div class="left-column">
      ...
      <div class="social">
            ...
            <a :href="contactLinks.email" class="external-link">
                <i class="fa fa-mail-forward contact-icon"></i>
                <span class="block-marged txt-full-white">
                {{ person.contact.email }}
                </span>
            </a>

            <a :href="contactLinks.phone" class="external-link">
      ...
      <div class="education-section">
        <div class="education-header">
          ...
          <span class="education-text txt-full-white">{{ lang.education }}</span>
        </div>
          ...
          <div v-for="(education, index) in person.education" :key="index"
            ...
            :href="education.website">
             ...
             <a class="external-link">
                ...
                <span class="multi-line-txt"> {{ education.description }} </span>
      ...
      <div class="experience-section section">
        ...
        <div class="section-content">
          <a v-for="(experience, index) in person.experience" :key="index"
            ...
            <span class="section-content__subheader"> {{ experience.company }} <span class="timeperiod"> {{ experience.timeperiod }} </span> </span>
            <ul class="job-description" v-if="Array.isArray(experience.description)">
                <li v-for="(description, descriptionIndex) in experience.description" :key="descriptionIndex">
                    {{ description }}
                </li>
            </ul>
            <span v-if="!Array.isArray(experience.description)" class="section-content__text--light"> {{ experience.description }}</span>
          </a>
        </div>
      </div>
